...
train_ma_list = [0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 0.55, 0.6, 0.65]
test_ma_list = [0.7, 0.75, 0.8]
...
if args.dataset == 0:
    process_dataset = PairDataset(
        ...
        train_re_list,
        train_aoa_list,
        "train_coarse_{:d}s".format(n_slices),
        n_slices,
    )
elif args.dataset == 1:
    process_dataset = PairDataset(
        ...
        test_re_list,
        test_aoa_list,
        "test_coarse_{:d}s".format(n_slices),
        n_slices,
    )
...
if args.dataset == 2:
    process_dataset = PairDataset(
        ...
        train_re_list,
        train_aoa_list,
        "train_fine_{:d}s".format(n_slices),
        n_slices,
    )
elif args.dataset == 3:
    process_dataset = PairDataset(
        ...
        test_re_list,
        test_aoa_list,
        "test_fine_{:d}s".format(n_slices),
        n_slices,
    )
    ...
    process_dataset = PairDataset(
        ...
        [3e6, 4e6],
        [3, 4],
        "idev-train_coarse_{:d}s".format(n_slices),
        n_slices,
    )
elif args.dataset == 5:
    process_dataset = PairDataset(
        ...
        [5e6, 6e6],
        [5, 6],
        "idev-test_coarse_{:d}s".format(n_slices),
        n_slices,
    )
    ...
    process_dataset = PairDataset(
        ...
        [3e6, 4e6],
        [3, 4],
        "idev-train_fine_{:d}s".format(n_slices),
        n_slices,
    )
elif args.dataset == 7:
    process_dataset = PairDataset(
        ...
        [5e6, 6e6],
        [5, 6],
        "idev-test_fine_{:d}s".format(n_slices),
        n_slices,
    )
